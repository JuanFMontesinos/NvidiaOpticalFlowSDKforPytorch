...
def endpoint_error(flow_pred: np.ndarray, flow_gt: np.ndarray, valid_mask: Optional[np.ndarray] = None) -> np.ndarray:
    """
...
def average_endpoint_error(
    flow_pred: np.ndarray, flow_gt: np.ndarray, valid_mask: Optional[np.ndarray] = None
) -> float:
    """
...
def angular_error(flow_pred: np.ndarray, flow_gt: np.ndarray, valid_mask: Optional[np.ndarray] = None) -> np.ndarray:
    """
...
def average_angular_error(flow_pred: np.ndarray, flow_gt: np.ndarray, valid_mask: Optional[np.ndarray] = None) -> float:
    """
...
def fl_all(
    flow_pred: np.ndarray, flow_gt: np.ndarray, valid_mask: Optional[np.ndarray] = None, threshold: float = 3.0
) -> float:
    """
...
def compute_all_metrics(
    ...
    thresholds: Tuple[float, ...] = (1.0, 3.0, 5.0),
) -> Dict[str, float]:
    """
