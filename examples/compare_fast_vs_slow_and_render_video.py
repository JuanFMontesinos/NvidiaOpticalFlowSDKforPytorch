...
dataset = datasets.MPISintelDataset(
    root_dir=SINTEL_ROOT, split="training", pass_name=PASS_NAME
)
...
for seq_name, sample_indices in tqdm(
    sequences.items(), desc="Processing sequences"
):
